...
WaterRenderer_Old::WaterRenderer_Old(glm::mat4& projectionMatrix) : m_shader(WaterShader_Old("_waterShader"))
{
	m_shader.use();
...
WaterRenderer_Old::~WaterRenderer_Old()
{
}


void WaterRenderer_Old::render(glm::mat4& view, glm::mat4& model, glm::mat4& projection, glm::vec3& cameraPosition)
{
	//m_shader.use();
	//Update uniforms
